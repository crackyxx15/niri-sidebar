...
- **Cannot start the app:** Make sure the file is executable (`chmod +x niri-sidebar`).
- **Sidebar hides behind other windows:** Use the settings to enable “Always on Top.”
- **Menu options missing:** Restart the app and verify you have the latest version.
- **Issues with missing dependencies:** Although rare, update your Linux system libraries if needed (`sudo apt update && sudo apt upgrade`).

For advanced problems, check the open issues section on the repository page or the FAQ.

---

## 📖 About Niri window manager
